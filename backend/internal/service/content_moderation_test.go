...
func (r *contentModerationTestUserRepo) BatchUpdateLimits(ctx context.Context, userIDs []int64, concurrency, rpmLimit, tpmLimit *int) (int, error) {
...
func TestBuildContentModerationAccountDisabledEmailBody_ContainsBanDetails(t *testing.T) {
	...
	cfg := defaultContentModerationConfig()
	cfg.BanThreshold = 10
	body := buildContentModerationAccountDisabledEmailBody("paragateway <Admin>", &ContentModerationLog{
		UserID:          &userID,
	...
	require.Contains(t, body, "paragateway &lt;Admin&gt;")
}
