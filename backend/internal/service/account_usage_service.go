...
type UsageLogRepository interface {
	...
	ListExternalUsageLogs(ctx context.Context, params pagination.PaginationParams, filters ExternalUsageLogFilters) ([]ExternalUsageLog, *pagination.PaginationResult, *ExternalUsageLogTotals, error)
