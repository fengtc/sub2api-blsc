...
vi.mock("vue-i18n", async () => {
  ...
  const translations: Record<string, string> = {
    ...
    "admin.settings.upstreamBillingProbe.description": "定期获取 OpenAI API Key 所连接上游 paragateway 站点声明的计费倍率。",
...
describe("admin SettingsView payment visible method controls", () => {
  ...
  it("does not link payment guidance to upstream-branded documentation", async () => {
    const wrapper = mountView();
    ...
    expect(wrapper.html()).not.toContain("github.com/Wei-Shaw/sub2api");
  });
