...
const models: ModelEntry[] = [
  ...
  { name: 'codex-auto-review', provider: 'OpenAI', endpoint: '/v1/chat/completions', upstream: 'openai/codex-auto-review' },
  { name: 'gpt-4o-audio-preview', provider: 'OpenAI', endpoint: '/v1/chat/completions', upstream: 'openai/gpt-4o-audio-preview' },
  { name: 'gpt-4o-realtime-preview', provider: 'OpenAI', endpoint: '/v1/chat/completions', upstream: 'openai/gpt-4o-realtime-preview' },
  { name: 'gpt-5.2-2025-12-11', provider: 'OpenAI', endpoint: '/v1/chat/completions', upstream: 'openai/gpt-5.2-2025-12-11' },
  { name: 'gpt-5.2-chat-latest', provider: 'OpenAI', endpoint: '/v1/chat/completions', upstream: 'openai/gpt-5.2-chat-latest' },
  { name: 'gpt-5.2-pro', provider: 'OpenAI', endpoint: '/v1/chat/completions', upstream: 'openai/gpt-5.2-pro' },
  { name: 'gpt-5.2-pro-2025-12-11', provider: 'OpenAI', endpoint: '/v1/chat/completions', upstream: 'openai/gpt-5.2-pro-2025-12-11' },
  { name: 'gpt-5.3-codex', provider: 'OpenAI', endpoint: '/v1/chat/completions', upstream: 'openai/gpt-5.3-codex' },
  { name: 'gpt-5.3-codex-spark', provider: 'OpenAI', endpoint: '/v1/chat/completions', upstream: 'openai/gpt-5.3-codex-spark' },
  { name: 'gpt-5.4', provider: 'OpenAI', endpoint: '/v1/chat/completions', upstream: 'openai/gpt-5.4' },
  { name: 'gpt-5.4-2026-03-05', provider: 'OpenAI', endpoint: '/v1/chat/completions', upstream: 'openai/gpt-5.4-2026-03-05' },
  { name: 'gpt-5.4-mini', provider: 'OpenAI', endpoint: '/v1/chat/completions', upstream: 'openai/gpt-5.4-mini' },
  { name: 'gpt-5.5', provider: 'OpenAI', endpoint: '/v1/chat/completions', upstream: 'openai/gpt-5.5' },
  { name: 'gpt-image-1', provider: 'OpenAI', endpoint: '/v1/chat/completions', upstream: 'openai/gpt-image-1' },
