...
export interface User {
  ...
  tpm_limit?: number // User-level global TPM cap (0 = unlimited), aggregated across all keys/models/groups
...
export type GroupPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'copilot' | 'grok' | 'kimi' | 'zhipu' | 'deepseek' | 'composite'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'copilot' | 'grok' | 'kimi' | 'zhipu' | 'deepseek'
